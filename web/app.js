...
const PRESETS = {
  ...
  fishnet: {
    grid: 10,
    pieces: [
      [[0, 1], [9, 10], [10, 10], [10, 9], [1, 0], [0, 0]],
      [[0, 9], [9, 0], [10, 0], [10, 1], [1, 10], [0, 10]],
      [[0, 2], [0, 4], [4, 0], [2, 0]],
      [[2, 10], [0, 8], [0, 6], [4, 10]],
      [[10, 6], [6, 10], [8, 10], [10, 8]],
      [[10, 2], [8, 0], [6, 0], [10, 4]],
    ],
    weave: { "0,2,0": 0, "1,5,0": 1 },
    palette: { 0: "#ff2929", 1: "#009400", 2: "#4d4dfe" },
  },
  highway: {
    grid: 13,
    pieces: [
      [[11, 13], [11, 12], [3, 12], [3, 13], [2, 13], [2, 11], [12, 11], [12, 13]],
      [[8, 13], [8, 10], [0, 10], [0, 9], [9, 9], [9, 13]],
      [[13, 10], [11, 10], [6, 4], [6, 0], [7, 0], [7, 3], [12, 9], [13, 9]],
      [[4, 0], [4, 3], [12, 3], [12, 0], [11, 0], [11, 2], [5, 2], [5, 0]],
      [[4, 13], [4, 6], [8, 4], [8, 0], [9, 0], [9, 5], [5, 7], [5, 13]],
      [[7, 13], [7, 8], [3, 4], [3, 0], [2, 0], [2, 5], [6, 9], [6, 13]],
      [[13, 7], [0, 7], [0, 6], [13, 6]],
    ],
    weave: {
      "5,6,0": 6, "4,5,0": 5, "2,6,0": 2, "0,1,0": 0, "4,6,0": 6,
      "1,4,0": 4, "1,5,0": 1, "0,5,0": 5, "2,3,0": 3, "3,4,0": 4,
    },
    palette: { 0: "#ff6666", 1: "#bdffbd", 2: "#a8a8ff", 3: "#1aabff" },
  },
  traffic: {
    grid: 24,
    pieces: [
      [[18, 24], [3, 15], [14, 0], [17, 0], [6, 14], [21, 24]],
      [[13, 24], [5, 19], [21, 0], [18, 0], [2, 20], [10, 24]],
      [[14, 24], [0, 16], [10, 0], [13, 0], [2, 15], [17, 24]],
      [[24, 20], [0, 9], [0, 11], [24, 22]],
      [[2, 24], [18, 9], [22, 9], [24, 9], [24, 11], [19, 11], [17, 13], [4, 24]],
      [[2, 0], [0, 4], [0, 6], [1, 5], [3, 2], [4, 0]],
      [[24, 4], [20, 5], [17, 5], [11, 5], [8, 2], [7, 0], [5, 0], [6, 2],
       [8, 5], [10, 7], [17, 7], [21, 7], [24, 6]],
      [[5, 24], [2, 23], [0, 22], [0, 20], [2, 21], [5, 22], [7, 24]],
    ],
    weave: {
      "1,4,0": 1, "2,4,0": 4, "2,3,0": 3, "2,6,0": 2,
      "1,2,0": 2, "0,1,0": 1, "0,4,0": 0, "3,4,0": 4,
    },
    palette: {
      0: "#e63946", 1: "#66b7f4", 2: "#2a9d8f",
      3: "#8367ad", 4: "#e85e8c", 5: "#3fd039",
    },
  },
};
